        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-black leading-relaxed mb-6">
              Delivering innovative solutions across healthcare, technology, and
              trading, connecting communities and creating lasting impact
              worldwide.
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-pristine-blue hover:text-white transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
