    ...
    <header className="absolute top-0 left-0 right-0 z-50 py-4 px-6">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <nav className="hidden md:flex space-x-8">
          <Link to="/" className="text-gray-700 hover:text-pristine-blue transition-colors font-medium">
            Home
          </Link>
          <Link to="/about" className="text-gray-700 hover:text-pristine-blue transition-colors font-medium">
            About
          </Link>
          ...
          <Link to="/services" className="text-gray-700 hover:text-pristine-blue transition-colors font-medium">
            Services
          </Link>
          <Link to="/contact" className="text-gray-700 hover:text-pristine-blue transition-colors font-medium">
            Contact Us
          </Link>
        </nav>
      </div>
