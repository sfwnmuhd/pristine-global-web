    ...
    <div className="min-h-screen bg-white font-instrument">
      ...
      <section className="relative pt-32 pb-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Get in touch with our team. We're here to help with any inquiries you may have.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              <h2 className="text-4xl font-semibold text-black mb-8">Get in Touch</h2>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-gray-900">UK Headquarters</h4>
