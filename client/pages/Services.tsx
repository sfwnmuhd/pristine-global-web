...
const services = [
  {
    ...
    description:
      "Comprehensive healthcare solutions including care homes, child care facilities, and medical consultancy services.",
  ...
  },
  {
    ...
    description:
      "Cutting-edge technology services and IT solutions to drive digital transformation across industries.",
  ...
  },
  {
    ...
    description:
      "Strategic retail operations and distribution networks spanning multiple countries and regions.",
    ...
    <div className="min-h-screen bg-white font-instrument">
      ...
      <section className="relative pt-32 pb-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Comprehensive solutions across healthcare, technology, and retail
            sectors to meet diverse business needs.
          </motion.p>
        </div>
      </section>
