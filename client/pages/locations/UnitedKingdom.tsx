    ...
    <div className="min-h-screen bg-white font-instrument">
      ...
      <section className="relative pt-32 pb-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Three care homes and one child care facility offering specialized, person-centered care across the UK.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-3xl font-semibold text-black mb-6">Compassionate Care Services</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              />
              <h3 className="text-3xl font-semibold text-black">Upcoming Project</h3>
            </div>
            <p className="text-xl text-gray-700 leading-relaxed">
              A new 50-bed nursing home in Stoke-on-Trent is in development, underscoring our growth ambitions and commitment to expanding quality care services across the UK.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h4 className="text-xl font-semibold text-black mb-4">UK Headquarters</h4>
            <p className="text-gray-700 mb-4">
              Hawthorne House, 17a Hawthorne Drive<br />
              Leicester, England, LE5 6DL
            </p>
            <p className="text-gray-700">
              <strong>Phone:</strong> 07868 751 907<br />
